<template>
    ...
    <div>
        ...
        <Layout>
            ...
            <h1 class="text-3xl font-bold">Ubications</h1>
           ...
           <div class="mb-6">
                <table class="rounded-t-lg m-5 w-full mx-auto bg-gray-200 text-gray-800">
                    ...
                    <tbody>
                    <tr v-for="ubication in ubications.data" :key="ubication.id" class="bg-gray-100 border-b border-gray-200">
                        <td class="px-4 py-3">
                            {{ ubication.id}}
                        </td>
                        <td class="px-4 py-3">
                        ...
                        <div class="flex justify-center text-center mt-4 mb-4 ">
                                <div class="w-4 transform mr-8 relative hover:text-green-500 hover:scale-110">
                                    <Link :href="`/ubications/edit/${ubication.id}`">
                                        <i class="fa-solid fa-pencil"></i>
                                    </Link>
                                </div>
                                <div class="w-4 transform hover:text-red-500 hover:scale-110">
                                    <button type="buttton" @click="destroy(ubication.id)">
        ...
        <Pagination :links="ubications.links" class="fixed bottom-0 left-10 mb-16" />
