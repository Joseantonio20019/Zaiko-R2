<template>
    ...
    <div>
        ...
        <h1 class="text-3xl text-center">Edit Status</h1>
        ...
        <form @submit.prevent="submit" class="max-w-md mx-auto mt-8">
            ...
            <div class="mb-6">
                ...
                <button type="submit" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500" :disabled="form.processing" >Edit Status</button>
