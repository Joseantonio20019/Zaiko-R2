...
<div>
    ...
    <h1 class="text-3xl text-center font-bold">Create a New Monitor</h1>
   ...
   <form @submit.prevent="submit" action="/" class="max-w-md mx-auto mt-8">
            ...
            <div class="mb-6">
                ...
                <label>HDMI</label>
                <br> 
                <input type="checkbox" v-model="form.vga" name="vga" id="vga" class="mr-2">
                <label>VGA</label>
                
                <br> 
                <input type="checkbox" v-model="form.dvi" name="dvi" id="dvi" class="mr-2">
                <label>DVI</label>
                <br>
                <input type="checkbox" v-model="form.displayport" name="displayport" id="displayport" class="mr-2">  
