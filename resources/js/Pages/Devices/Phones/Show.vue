    ...
    <div>
        ...
        <Layout>
            ...
            <div class="text-center w-auto place-items-stretch">
                <Link class=" mb-6 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" :href="`/register/create/${phone.device_id}`">
         ...
         <div class="flex justify-between px-4 mt-6">
            ...
            <div class="p-4 border-b">
                ...
                <p class="text-sm text-gray-500">
                    {{registerdevice.sitealias}} - {{registerdevice.departmentalias}} - {{phone.device["inventory_number"]}}
                </p>
            </div>
            <div>
                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                            ...
                            <p v-if="phone.device['comment'] != null">

                                {{phone.device["comment"]}}                    
                            </p>
                            <p v-else>
                                No Comment
                            </p>
