...
<div>
    ...
    <h1 class="text-3xl text-center font-bold">Create a New Printer</h1>
    ...
    <form @submit.prevent="submit" action="/" class="max-w-md mx-auto mt-8">
            ...
            <div class="mb-6">
                ...
                <label for="Black&White" class="ml-2">Black & White</label>
            ...
            <div class="mb-6">
                ...
                <label class="ml-2">USB</label>
                <br>
                <input type="checkbox" v-model="form.com" name="com" id="com">
                <label class="ml-2">COM</label>
                <br>
                <input type="checkbox" v-model="form.wifi" name="wifi" id="wifi"> 
                <label class="ml-2">WIFI</label>
                <br>
                <input type="checkbox" v-model="form.ethernet" name="ethernet" id="ethernet"> 
                <label class="ml-2">Ethernet</label>
