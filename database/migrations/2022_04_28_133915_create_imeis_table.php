...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('imeis', function (Blueprint $table) {
            ...
            $table->foreign('pda_id')->references('id')->on('pdas')->onUpdate('cascade')->onDelete('cascade');
            $table->unsignedBigInteger('phones_id')->index();
            $table->foreign('phones_id')->references('id')->on('phones')->onUpdate('cascade')->onDelete('cascade');
